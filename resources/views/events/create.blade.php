                ...
                <div class="panel-body">
                    <form action="{{ route('events.store') }}" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" id="inputTitle" placeholder="Title Event" name="title"> 
                          </div>
                        </div> 
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <input type="url" class="form-control" id="inputImg" placeholder="Picture Event" name="img"> 
                          </div>
                        </div> 
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <input type="date" class="form-control" id="inputDate"  name="at"> 
                          </div>
                        </div> 
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <textarea class="form-control" rows="5" id="textContent" placeholder="Content Event" name="content"></textarea> 
                          </div>
                        </div>
